                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="input-group my-2">
                                <label for="codigo" class="input-group-text col-sm-3">Codigo</label>
                                <input type="text" class="form-control col-sm-9" name="codigo" id="codigo">
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-group my-2">
                                <label for="nombres" class="input-group-text col-sm-3">Nombres</label>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            <label for="s_codigo" class="input-group-text col-sm-3">Codigo</label>
                            <input type="text" class="form-control col-sm-9" id="s_codigo" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            <label for="s_nombres" class="input-group-text col-sm-3">Nombres</label>
                            <input type="text" class="form-control col-sm-9" id="s_nombres" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            <label for="s_apellidos" class="input-group-text col-sm-3">Apellidos</label>
                            <input type="text" class="form-control col-sm-9" id="s_apellidos" readonly>
                        </div>
                    </div>
                    <div class="row justify-content-md-center">
                        <div class="col-md-12 my-2 text-center">
                            <img id="qr_alumno" class="img-fluid" alt="Código QR del alumno" width="200">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                .then(response => {
                    if (response && response.res == 'ok') {
                        ...
                        Swal.fire({
                            ...
                            text: 'Los datos del alumno fueron actualizados',
                            icon: 'success',
                            showCancelButton: false,
                            confirmButtonColor: '#3085d6',
                            confirmButtonText: 'Cerrar'
        ...
        const show_alumno = async (act, url) => {
            try {
                ...
                if (act == 'show') {
                    ...
                    // El QR viene en formato SVG base64
                    $('#qr_alumno').attr('src', `data:image/svg+xml;base64,${alumno.qr}`);
            ...
            alumnos.forEach(alumno => {
                ...
                table.row.add([
                    ...
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-secondary btn-sm" onclick="alumno('editar','${ruta_show}','${ruta_update}')" title="Editar"><i class="fas fa-user-edit"></i></button>
